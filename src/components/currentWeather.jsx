...
export const CurrentWeather = ({ locationKey }) => {
  ...
  return (
    weatherData && (
      <div className='mt-6 mx-20 h-full bg-center bg-cover rounded-md' style={{
        backgroundImage: `url(./skybg.jpg)`
      }}>
        <h1 className='text-center font-bold font-serif text-indigo-50 text-2xl p-6'>Current Weather</h1>
        <div className='flex justify-center gap-x-6'>
          <div className='flex w-1/3 justify-around items-center'>
            <div className='flex flex-col h-full'>
              ...
              <p className='text-center font-sans text-sm text-indigo-50 mb-3'>{weatherData.WeatherText}</p>
            </div>
            <p className='text-center text-indigo-50 text-5xl'>{weatherData.Temperature.Metric.Value} °{weatherData.Temperature.Metric.Unit}</p>
          </div>
          <div className='font-normal text-indigo-50 font-sans '>
